...
/* harmony import */ var lodash_chunk__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash.chunk */ "./node_modules/lodash.chunk/index.js");
...
/* harmony import */ var lodash_padstart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash.padstart */ "./node_modules/lodash.padstart/index.js");
...
/* harmony import */ var _sprite__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sprite */ "./resources/js/sprite.js");
...
var container = document.querySelector("#screen__content");
var currentChunkId = 0;
var currentGuestId = 0;
var screen = "loading";
var guests = lodash_chunk__WEBPACK_IMPORTED_MODULE_1___default()(JSON.parse(document.getElementById("guests").innerHTML), 6);
...
function handleControls() {
  ...
  document.getElementById("bottom").addEventListener("click", nextControlMutation);
  document.getElementById("a-button").addEventListener("click", guestDetailScreen);
...
function guestsScreen() {
  screen = "guests";
  container.innerHTML = "";
  var guestsScreen = document.createElement("ul");
  guestsScreen.classList.add("guests");
  guests[currentChunkId].map(buildItem).map(function (guest, idx) {
    if (idx === currentGuestId) guest.classList.add("current");
    return guest;
  }).forEach(function (guest) {
    return guestsScreen.appendChild(guest);
  });
  container.innerHTML = "";
...
function guestDetailScreen() {
  var guest = guests[currentChunkId][currentGuestId]; // Create main container

  var mainContainer = document.createElement("div");
  mainContainer.classList.add("guest__detail__screen"); // Create characteristics container and elements

  var charContainer = document.createElement("div");
  charContainer.classList.add("guest__detail__char");
  var charLeft = document.createElement("div");
  charLeft.classList.add("guest__left");
  var sprite = document.createElement("canvas");
  sprite.setAttribute("width", "56px");
  sprite.setAttribute("height", "56px");
  (0,_sprite__WEBPACK_IMPORTED_MODULE_3__["default"])(sprite, guest.sprite[0], guest.sprite[1]);
  var id = document.createElement("div");
  id.innerHTML = "<div><span class=\"id__prefix\">No.</span> ".concat(lodash_padstart__WEBPACK_IMPORTED_MODULE_2___default()(guest.id, 3, 0), "</div>");
  charLeft.appendChild(sprite);
  charLeft.appendChild(id);
  var charRight = document.createElement("div");
  ...
  charContainer.appendChild(charRight); // Create description
...
function _boot() {
  _boot = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var content, loader, endAfter;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            content = document.querySelector("#boot");
            loader = setInterval(function () {
              if (content.innerHTML === "Chargement...") return content.innerHTML = "Chargement.";
              return content.innerHTML = content.innerHTML + ".";
            }, 800);
            endAfter = Math.floor(Math.random() * 10) * 900;
            setTimeout(function () {
              return cleanLoading(loader, content);
            }, endAfter);
...
/* harmony export */   "default": () => (/* binding */ setSprite)
/* harmony export */ });
var SPRITE_WIDTH = 60;
...
function setSprite(canvas, row, col) {
  var context = canvas.getContext('2d');
  var position = spritePositionToImagePosition(row, col);
  context.drawImage(document.getElementById('sprites'), position.x, position.y, SPRITE_WIDTH, SPRITE_HEIGHT, 0, 0, SPRITE_WIDTH, SPRITE_HEIGHT);
}
